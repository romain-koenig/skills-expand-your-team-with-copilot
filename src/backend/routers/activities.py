...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all' for activities with no difficulty set). If not provided, all activities are returned regardless of difficulty.
    """
